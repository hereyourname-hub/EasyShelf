    ...
    private void showAddShoeDialog() {
        ...
        builder.setPositiveButton("Добавить", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Shoe1 shoe1 = new Shoe1(shoeNumber, shoeName);

                // Сохраняем данные в базе данных Firebase
                String userId = currentUser.getUid();
                DatabaseReference userShoesRef = databaseReference.child("users").child(userId).child("shoes1");
                String key = userShoesRef.push().getKey();
                userShoesRef.child(key).setValue(shoe1);
            }
        });
    ...
    private void deleteSelectedShoes() {
        ...
        while (iterator.hasNext()) {
            ...
            if (entry.getValue()) {
                ...
                DatabaseReference userShoesRef = databaseReference.child("users").child(currentUser.getUid()).child("shoes1");
        ...
        userShoesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot shoeSnapshot : dataSnapshot.getChildren()) {
                    Shoe1 shoe1 = shoeSnapshot.getValue(Shoe1.class);
                    if (shoe1 != null) {
                        String shoeKey = shoeSnapshot.getKey();
                        String shoeInfo = "№ " + shoeNumber + " " + shoe1.getShoeName();
